...
public class Impressum extends VBox {
    public Impressum(Stage primaryStage) {
        ...
        CText ctex = new CText("Angriff:", "Die Special-Fähigkeit des Kammernjägers stellt einen Pointer dar. Pointer sind ein Markenzeichen von C und sorgen für ein unvergleichlich effektives Speichermanagement. Infolge dessen ist C eine der performantesten Sprachen die es gibt.");
